...
const PICKS = [
  ...
  {sport:'ufc',matchup:'Allen vs Costa',call:'Allen ML',
   why:'Allen -188 justified. Five-round fight, volume striker, never been stopped in 24 fights. Sharp money moved line from -154 to -188. Only 52% of public bets but 71% of sharp dollars. RLM confirmed.',
   rating:'HIGH VALUE',units:'1.5u',tier:'free'},
  {sport:'ufc',matchup:'Allen vs Costa',call:'Over 4.5 rounds',
   why:'Allen goes to decision. 5 of his last 6 fights went the distance. Costa fades past round 3. Sharp money hammered this all week. Line moved -130 to -166. Take the Over.',
   rating:'FREE MONEY',units:'2u',tier:'wynnr'},
  {sport:'ufc',matchup:'Allen vs Costa',call:'Costa +ML',
   why:'Contrarian dart. Costa +155 with 6-fight win streak and two first-round finishes. Chute Boxe power. If he lands clean early, this is over fast. Small action only.',
   rating:'LEAN',units:'0.5u',tier:'wynnr'},
  // NBA Playoffs - Second Round
  {sport:'nba',matchup:'Pistons vs Cavaliers',call:'Cavaliers +4.5',
   why:'Cavs won 3 straight after going down 0-2. Mitchell locked in. Detroit has Huerter, LeVert and Robinson all questionable. Sharp money on Cleveland. Take the points.',
   rating:'HIGH VALUE',units:'1.5u',tier:'free'},
  {sport:'nba',matchup:'Spurs vs Timberwolves',call:'Spurs -10.5',
   why:'Wembanyama back and motivated after the ejection game. SA leads series 3-2 at home. Only 41% of public bets but 73% of sharp dollars on San Antonio. Massive RLM. Lay the number.',
   rating:'HIGH VALUE',units:'1.5u',tier:'wynnr'},
  {sport:'nba',matchup:'Pistons vs Cavaliers',call:'Over 211.5',
   why:'Over hit in 2 straight games in this series. Both teams up-tempo. Mitchell and Cunningham both projected 26+ points. Pace increases in elimination scenarios.',
   rating:'LEAN',units:'1u',tier:'wynnr'},
  {sport:'nba',matchup:'2026 NBA Finals',call:'Thunder to win title',
   why:'OKC is 8-0 in playoffs and swept the Lakers. Jalen Williams getting healthy. Best team top to bottom. -165 is still value for a team this dominant. Lock in before it hits -200.',
   rating:'HIGH VALUE',units:'1u',tier:'wynnr'},
  // MLB
  {sport:'mlb',matchup:'Dodgers vs Cubs',call:'Dodgers ML',
   why:'Ohtani confirmed in lineup after rest day. Cubs bullpen ranked 28th in ERA last 2 weeks. Steam move confirmed - line moved -145 to -160. Public and sharps both on LA.',
   rating:'HIGH VALUE',units:'1u',tier:'free'},
  {sport:'mlb',matchup:'Yankees vs Red Sox',call:'Yankees ML',
   why:'Line flipped from +105 to -110 on sharp action alone. 67% of sharp dollars on Yankees despite public split. Boston bullpen struggles in primetime. Follow the money.',
